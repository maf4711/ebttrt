...
| | |
|---|---|
| GitHub | `maf4711/ebttrt` |
| SSH | `git@github.com:maf4711/ebttrt.git` |
| Remote dieses Checkouts | `git@github.com:maf4711/ebttrt.git` |
| Ordner | `~/Developer/ebttrt` |
| Default-Branch | `main` |

### Release

- GitHub Actions: `prove.yml`. Der Default-Branch bleibt der auslieferbare Stand.
...
3. Dieser Checkout liegt danach unter `~/Developer/ebttrt`. Weicht der Ordner vom Repo-Namen ab, weil zwei Orgs denselben Namen haben, heißt er `~/Developer/<owner>--<name>`.
